...
class ResumesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resume" do
    assert_difference("Resume.count") do
      post resumes_url, params: { resume: { description: @resume.description, image: @resume.image, title: @resume.title } }
    end
  ...
  test "should update resume" do
    patch resume_url(@resume), params: { resume: { description: @resume.description, image: @resume.image, title: @resume.title } }
