...
class ConferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create conference" do
    assert_difference("Conference.count") do
      post conferences_url, params: { conference: { date: @conference.date, link: @conference.link, locate: @conference.locate } }
    end
  ...
  test "should update conference" do
    patch conference_url(@conference), params: { conference: { date: @conference.date, link: @conference.link, locate: @conference.locate } }
